...
export class CheckOrders {
  constructor(private _CheckOrdersServices: CheckOrdersServices, private _ToastrService: ToastrService, private _ActivatedRoute: ActivatedRoute,private _Router:Router) { }
